...
public class Enunciado implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Enunciado)) {
            return false;
        }
        Enunciado other = (Enunciado) object;
    ...
    public String toString() {
        return "Enunciado{" + "id=" + id + ", descripcion=" + descripcion + ", dificultad=" + dificultad + ", disponibleClase=" + disponibleClase + '}';
    }
